...
<head>
	...
	<script type="text/javascript" src="${request.contextPath}/static/js/page/user/userInfo.js"></script>
	<script type="text/javascript" src="${request.contextPath}/static/js/cacheUserInfo.js"></script>
</head>
	...
	<form class="layui-form layui-row">
		<div class="layui-col-md3 layui-col-xs12 user_right">
			<div class="layui-upload-list">
				<img class="layui-upload-img layui-circle userFaceBtn userAvatar"
					id="userFace">
			</div>
		...
		<div class="layui-col-md6 layui-col-xs12">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block userHobby">
					...
					<input type="checkbox" name="like[C#]" title="C#"> <input
						type="checkbox" name="like[php]" title="PHP"> <input
						type="checkbox" name="like[html]" title="HTML(5)"> <input
